...
class matlabIoTest extends AnyFlatSpec {
  matlabIo.matlabWorkingSpace = java.nio.file.Paths.get("./MatlabFiles/")
  val eng = matlabIo.eng
  matlabIo.EngUtil(eng).setWorkingDir("./MatlabFiles/")
  ...
  "WriteFile" should "do correctly" in {
    ...
    val readFile = Source.fromFile("./MatlabFiles/" + writeFileName)
